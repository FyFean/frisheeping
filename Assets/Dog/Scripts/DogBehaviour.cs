...
public abstract class DogBehaviour
{
    ...
    public abstract DogBehaviour.Movement GetDesiredMovement(DogBehaviour.Movement currentMovement);
    ...
    public List<SheepController> getSheepList()
    {
        ...
        { // localized perception
            if (GM.DogsParametersStrombom.occlusion)
                sheep = sheep.Where(sc => dc.IsVisible(sc, GM.DogsParametersStrombom.blindAngle));
